...
DATABASES = {
    'default': {
        ...
        'NAME': 'shawen$beemathworld',
        'USER': 'shawen',
        'PASSWORD': 'Guessroom1',
        'HOST': 'shawen.mysql.pythonanywhere-services.com',
    }
}
...
EMAIL_HOST = 'mail.beemathworld.ng'
EMAIL_PORT = 465
# EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER")
EMAIL_HOST_USER='support@beemathworld.ng'
# EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD")
EMAIL_HOST_PASSWORD='Shawenbaba1'
